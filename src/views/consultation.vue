    ...
    <div class="sidebar">
      <div class="ai-assistant-info">
        <div class="breathing-circle">
            <el-image :src="iconUrl1" style="width: 20px; height: 20px;" alt="AI助手" />
        </div>
      ...
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <el-image :src="iconUrl2" style="width: 30px; height: 30px;" alt="AI助手" />
          </div>
          <div class="chat-info">
            <h2>宁渡AI助手</h2>
            <p>您的贴心AI心理健康助手</p>
        ...
        <el-button circle title="新建会话" @click="createNewFrontSession">
          <el-icon>
            <Plus />
          </el-icon>
        </el-button>
        ...
        <div class="message-item ai-message" v-if="messages.length === 0">
          ...
          <div class="message-content">
            <div class="message-bubble">
              <p>你好，我是小暖，您的AI心理健康助手，很高兴能陪伴你，跟我分享一下今天过的怎么样吧</p>
            </div>
